...
local 
	...
	--	#-Sunog
	--º Colocar x-y-z no travelNode
	travelNode = keywordHandler:addKeyword({'Sunog'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Custa 1000gps pelo transporte, deseja continuar para o destino escolhido?'})
    travelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = true, level = 0, cost = 1000, destination = {x = 0, y = 0, z = 0}})
    travelNode:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = 'Entendemos, boa sorte em sua caminhada.'})
	
	--	#-Hydra Camp
	--º Colocar x-y-z no travelNode
	travelNode = keywordHandler:addKeyword({'Hydra Camp'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Custa 1000gps pelo transporte, deseja continuar para o destino escolhido?'})
    travelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = true, level = 0, cost = 1000, destination = {x = 0, y = 0, z = 0}})
    travelNode:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = 'Entendemos, boa sorte em sua caminhada.'})
